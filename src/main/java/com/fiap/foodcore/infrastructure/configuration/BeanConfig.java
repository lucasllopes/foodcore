...
public class BeanConfig {
    ...
    @Bean
    public CreateRestaurantUseCase createRestaurantInteractor(RestaurantGateway restaurantGateway, FindUserByIdUseCase findUserByIdUseCase) {
        return new CreateRestaurantInteractor(restaurantGateway, findUserByIdUseCase);
    }
