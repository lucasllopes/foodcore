...
public class UserSubtypeController {
    ...
    private final static Logger logger = LoggerFactory.getLogger(UserSubtypeController.class);
    ...
    public UserSubtypeController(CreateUserSubtypeUseCase createUserSubtype, UpdateUserSubtypeUseCase updateUserSubtype, FindUserSubtypeByIdUseCase findUserSubtypeById, FindUserSubtypeByNameUseCase findUserSubtypeByNameUseCase, DeleteUserSubtypeUseCase deleteUserSubtype) {
