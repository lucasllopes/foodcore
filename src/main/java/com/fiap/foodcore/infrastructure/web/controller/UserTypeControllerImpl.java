...
public class UserTypeControllerImpl implements UserTypeController {
    ...
    private final static Logger logger = LoggerFactory.getLogger(UserTypeControllerImpl.class);
    ...
    public UserTypeControllerImpl(CreateUserTypeUseCase createUserType, UpdateUserTypeUseCase updateUserType,
