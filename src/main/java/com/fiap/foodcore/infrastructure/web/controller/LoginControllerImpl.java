...
public class LoginControllerImpl implements LoginController {
    ...
    private final static Logger logger = LoggerFactory.getLogger(LoginControllerImpl.class);

    private final TokenGateway tokenGateway;

    private final AuthenticationManager authenticationManager;

    public LoginControllerImpl(TokenGateway tokenGateway, AuthenticationManager authenticationManager) {
