...
public class CriarClienteStrategy implements CriarUsuarioStrategy{
    ...
    public CriarClienteStrategy(UsuarioRepository usuarioRepository, PasswordEncoder passwordEncoder) {
    ...
    public UsuarioResponseDTO criar(UsuarioCreateRequestDTO dto) {
        ...
        Usuario usuario = UsuarioConverter.fromCreateDto(senhaCriptografada, TipoUsuario.CLIENTE, dto);
